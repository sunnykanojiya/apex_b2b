          ...
          <div className="container">
              <Reveal>
                  <div className="consulting__card">
                      <div className="consulting__badge">
                      ...
                      <p className="consulting__desc">
                          Each corporate program also includes consulting
                          support. Your team receives{" "}
                          <strong>one dedicated consulting sessions </strong>{" "}
                          where we help apply the systems directly to your
                          business.
                      </p>
                      ...
                      <p className="consulting__note">
                          Custom enterprise training is available for teams of
                          5+ members. We can tailor the program to your sales
                          process and GTM strategy.
                      </p>

                      <a href="#Enroll" className="btn btn-primary">
                          <span>Enroll Your Team</span>
                          <svg
                              width="18"
                              height="18"
                              viewBox="0 0 24 24"
